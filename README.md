...
- 5 [Settings][]
    ...
    - 5.4 [Built-in settings reference][]
        ...
        - 5.4.6 [LOG_STDOUT][]
        - 5.4.7 [LOG_FILE][]
    - 5.5 [Selectable settings reference][]
        - 4.5.1 [DATA_REPORT_FILE_NAME][]
        - 4.5.2 [DATA_REPORT_CSV_FILE_NAME, DATA_REPORT_SVG_FILE_NAME][]
        - 4.5.3 [MyDataReport.name][]
